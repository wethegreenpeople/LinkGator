...
export const PostCard: Component<PostCardProps> = (props) => {
  ...
  return (
    <article class="bg-gray-800 rounded-lg shadow-sm overflow-hidden mb-4">
      <div class="flex">
        {/* Vote Section */}
        <div class="flex flex-col items-center p-4 bg-gray-900 min-w-[60px]">
          <button 
        ...
        <div class="flex-1 p-4">
          ...
          <div class="flex items-center gap-4 text-gray-300">
            <button class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-800 transition-colors">
